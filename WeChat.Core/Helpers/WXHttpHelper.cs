...
namespace WeChat.Core
{
    ...
    public class HttpHelper
    {
        ...
        private void SetCookie(HttpItem item)
        {
            ...
            //设置CookieContainer
            if (item.ResultCookieType == ResultCookieType.CookieContainer)
            {
    ...
    #region
    public static class WXHttpHelper
    {
        ...
        {
            bool flag = string.IsNullOrWhiteSpace(strcookie);
            string result;
            if (flag)
            {
                result = string.Empty;
            ...
            else
            {
                ...
                string[] list = strcookie.ToString().Split(new string[]
                {
                    ",",
                    ";"
                ...
                foreach (string item in list)
                {
                    ...
                    bool flag2 = string.IsNullOrWhiteSpace(itemcookie);
                    if (!flag2)
                    {
                        bool flag3 = !itemcookie.Contains("=");
                        if (!flag3)
                        {
                            bool flag4 = itemcookie.Contains("path=");
                            if (!flag4)
                            {
                                bool flag5 = itemcookie.Contains("expires=");
                                if (!flag5)
                                {
                                    bool flag6 = itemcookie.Contains("domain=");
                                    if (!flag6)
                                    {
                                        bool flag7 = itemcookie.Contains("max-age=");
                                        if (!flag7)
                                        {
                                            bool flag8 = cookielist.Contains(item);
                                            if (!flag8)
                                            {
                                                bool flag9 = item.IndexOf("\"") > -1;
                                                if (flag9)
                                                {
                                                    bool flag10 = item.Substring(item.Length - 1) == "\"";
                                                    if (!flag10)
                                                    {
