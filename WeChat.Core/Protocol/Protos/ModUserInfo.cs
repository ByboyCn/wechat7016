namespace WeChat.Core.Protocol.Protos
{
    ...
    public class ModUserInfo : IExtensible
    {
        ...
        private WeChat.Core.Protocol.Protos.DisturbSetting _DisturbSetting = null;
        private int _Experience = 0;
        private uint _FaceBookFlag = 0;
        private string _FBToken = "";
        private ulong _FBUserID = 0L;
        private string _FBUserName = "";
        private WeChat.Core.Protocol.Protos.GmailList _GmailList = null;
        ...
        public WeChat.Core.Protocol.Protos.GmailList GmailList
        {
            get
            {
