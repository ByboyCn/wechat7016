namespace WeChat.Core.Protocol.Protos
{
    ...
    public class SnsAction : IExtensible
    {
        ...
        [ProtoMember(8, IsRequired = true, Name = "Content", DataFormat = DataFormat.Default), DefaultValue("")]
        ...
        [ProtoMember(9, IsRequired = true, Name = "ReplyCommentId", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
        ...
        [ProtoMember(12, IsRequired = true, Name = "ReplyCommentId2", DataFormat = DataFormat.TwosComplement), DefaultValue((float)0f)]
