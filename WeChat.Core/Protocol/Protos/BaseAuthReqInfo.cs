namespace WeChat.Core.Protocol.Protos
{
    ...
    public class BaseAuthReqInfo : IExtensible
    {
        ...
        private WeChat.Core.Protocol.Protos.WTLoginImgReqInfo _WTLoginImgReqInfo = null;
        private SKBuiltinBuffer_t _WTLoginReqBuff = null;
        private WeChat.Core.Protocol.Protos.WxVerifyCodeReqInfo _WxVerifyCodeReqInfo = null;
        ...
        public WeChat.Core.Protocol.Protos.WTLoginImgReqInfo WTLoginImgReqInfo
        {
            get
            {
        ...
        public WeChat.Core.Protocol.Protos.WxVerifyCodeReqInfo WxVerifyCodeReqInfo
        {
            get
            {
