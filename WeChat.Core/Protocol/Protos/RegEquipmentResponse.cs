namespace WeChat.Core.Protocol.Protos
{
    ...
    public class RegEquipmentResponse : IExtensible
    {
        ...
        private WeChat.Core.Protocol.Protos.BuiltinIPList _BuiltinIPList;
        private string _FSURL = "";
        private WeChat.Core.Protocol.Protos.NetworkControl _NetworkControl;
        private HostList _NewHostList;
        private string _OfficialNickName = "";
        private string _OfficialUserName = "";
        private string _Password = "";
        private WeChat.Core.Protocol.Protos.PluginKeyList _PluginKeyList;
