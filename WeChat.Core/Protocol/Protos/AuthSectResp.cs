...
namespace WeChat.Core.Protocol.Protos
{
    ...
    public class AuthSectResp : IExtensible
    {
        ...
        private WeChat.Core.Protocol.Protos.WTLoginImgRespInfo _WTLoginImgRespInfo = null;
        private SKBuiltinBuffer_t _WTLoginRspBuff = null;
        private uint _WTLoginRspBuffFlag;
        private WeChat.Core.Protocol.Protos.WxVerifyCodeRespInfo _WxVerifyCodeRespInfo = null;
        ...
        public WeChat.Core.Protocol.Protos.WTLoginImgRespInfo WTLoginImgRespInfo
        {
            get
            {
        ...
        public WeChat.Core.Protocol.Protos.WxVerifyCodeRespInfo WxVerifyCodeRespInfo
        {
            get
            {
