namespace WeChat.Core.Protocol.Protos
{
    ...
    public class GetA8KeyResp : IExtensible
    {
        ...
        private WeChat.Core.Protocol.Protos.DeepLinkBitSet _DeepLinkBitSet = null;
        private string _FullURL = "";
        private WeChat.Core.Protocol.Protos.GeneralControlBitSet _GeneralControlBitSet = null;
        ...
        public WeChat.Core.Protocol.Protos.DeepLinkBitSet DeepLinkBitSet
        {
            get
            {
        ...
        public WeChat.Core.Protocol.Protos.GeneralControlBitSet GeneralControlBitSet
        {
            get
            {
