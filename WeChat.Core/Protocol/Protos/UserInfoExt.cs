namespace WeChat.Core.Protocol.Protos
{
    ...
    public class UserInfoExt : IExtensible
    {
        ...
        private WeChat.Core.Protocol.Protos.PatternLockInfo _PatternLockInfo = null;
        private uint _PayWalletType = 0;
        private string _RealName = "";
        private string _RegCountry = "";
        private uint _SafeDevice = 0;
        private WeChat.Core.Protocol.Protos.SafeDeviceList _SafeDeviceList = null;
        private string _SafeMobile = "";
        private string _SecurityDeviceId = "";
        private string _SmallHeadImgUrl = "";
        private WeChat.Core.Protocol.Protos.SnsUserInfo _SnsUserInfo;
        ...
        public WeChat.Core.Protocol.Protos.PatternLockInfo PatternLockInfo
        {
            get
            {
        ...
        public WeChat.Core.Protocol.Protos.SafeDeviceList SafeDeviceList
        {
            get
            {
