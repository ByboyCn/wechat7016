namespace WeChat.Core.Protocol.Protos
{
    ...
    public class PreSubmitOrderResponse : IExtensible
    {
        ...
        private WeChat.Core.Protocol.Protos.BaseResponse _BaseResponse = null;
        private readonly List<WeChat.Core.Protocol.Protos.Express> _Express = new List<WeChat.Core.Protocol.Protos.Express>();
        ...
        public List<WeChat.Core.Protocol.Protos.Express> Express
        {
            get
            {
